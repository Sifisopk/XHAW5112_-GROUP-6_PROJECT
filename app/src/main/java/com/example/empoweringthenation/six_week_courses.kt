...
class six_week_courses : AppCompatActivity() {
    override fun onCreate(savedInstanceState: Bundle?) {
        super.onCreate(savedInstanceState)
        enableEdgeToEdge()
        setContentView(R.layout.activity_six_week_courses)

        val childMinding = findViewById<Button>(R.id.childMindingBtn)
        childMinding.setOnClickListener {
            intent = Intent(this, Child_Minding::class.java)
        ...
        val gardenMaintenance = findViewById<Button>(R.id.gardenMaintenanceBtn)
        gardenMaintenance.setOnClickListener {
            intent = Intent(this, Garden_Maintenance::class.java)
            startActivity(intent)
        }
