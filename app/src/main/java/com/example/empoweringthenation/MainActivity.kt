...
class MainActivity : AppCompatActivity() {
    override fun onCreate(savedInstanceState: Bundle?) {
      ...
      val sixMonthlist = findViewById<Button>(R.id.sixMonthlist)
      val sixWeekList = findViewById<Button>(R.id.sixweeklist)

        sixWeekList.setOnClickListener {
            intent = Intent(this, six_week_courses::class.java)
            startActivity(intent)
        }

        sixMonthlist.setOnClickListener {
